...
def apply_lora_clip(model, training_type, model_name, target_modules, lora_rank, lora_alpha, lora_dropout, device, position="all"):
    ...
    assert training_type in ["text_image_header", "text_image_contrastive", "image_encoder_only", "MAD_training", "test_clip"]

    if training_type in ["text_image_header", "text_image_contrastive", "image_encoder_only", "MAD_training", "test_clip"]:
